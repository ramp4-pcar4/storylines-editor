import{r as e}from"./vec3f64-CG5ySZkG-Dj7yz7Fz.js";import{v as t}from"./vec3-D0JSMCWt-DxhzA4EA.js";import{l as n}from"./vec4-DtLpLkJR-NX0lHSHq.js";import{n as r}from"./vec4f64-DFGee9an-D35VCg20.js";import{n as i,t as a}from"./glsl-EDZkDhgF-BmlD_e8i.js";import{t as o}from"./Uniform-Dp2mgLmf-sDlmDzvo.js";import{c as s}from"./Emissions.glsl-C1fRgyHC-BKFlnvac.js";import"./NoParameters-DvFAVXX5-CiYgpw4s.js";import{l as c}from"./AlphaCutoff-lGKpUdxr-Dq_Xw974.js";import{t as l}from"./Float3BindUniform-Cmo9nXvW-D9TopQkY.js";import{t as u}from"./FloatBindUniform-avAg5yxD-BlJbJU9Q.js";import{i as d}from"./Transform.glsl-B8LYsJdc-ChhjZx_e.js";import{t as f}from"./PiUtils.glsl-E150IKCl-OUl2tba3.js";import{t as p}from"./Float4BindUniform-BljimXR4-kSURy96v.js";var m=3e5,h=5e5;function g(e,r){let i=r.lightingSphericalHarmonicsOrder===void 0?2:r.lightingSphericalHarmonicsOrder;i===0?(e.uniforms.add(new l(`lightingAmbientSH0`,({lighting:e})=>t(_,e.sh.r[0],e.sh.g[0],e.sh.b[0]))),e.code.add(a`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
return ambientLight * (1.0 - ambientOcclusion);
}`)):i===1?(e.uniforms.add(new p(`lightingAmbientSH_R`,({lighting:e})=>n(v,e.sh.r[0],e.sh.r[1],e.sh.r[2],e.sh.r[3])),new p(`lightingAmbientSH_G`,({lighting:e})=>n(v,e.sh.g[0],e.sh.g[1],e.sh.g[2],e.sh.g[3])),new p(`lightingAmbientSH_B`,({lighting:e})=>n(v,e.sh.b[0],e.sh.b[1],e.sh.b[2],e.sh.b[3]))),e.code.add(a`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`)):i===2&&(e.uniforms.add(new l(`lightingAmbientSH0`,({lighting:e})=>t(_,e.sh.r[0],e.sh.g[0],e.sh.b[0])),new p(`lightingAmbientSH_R1`,({lighting:e})=>n(v,e.sh.r[1],e.sh.r[2],e.sh.r[3],e.sh.r[4])),new p(`lightingAmbientSH_G1`,({lighting:e})=>n(v,e.sh.g[1],e.sh.g[2],e.sh.g[3],e.sh.g[4])),new p(`lightingAmbientSH_B1`,({lighting:e})=>n(v,e.sh.b[1],e.sh.b[2],e.sh.b[3],e.sh.b[4])),new p(`lightingAmbientSH_R2`,({lighting:e})=>n(v,e.sh.r[5],e.sh.r[6],e.sh.r[7],e.sh.r[8])),new p(`lightingAmbientSH_G2`,({lighting:e})=>n(v,e.sh.g[5],e.sh.g[6],e.sh.g[7],e.sh.g[8])),new p(`lightingAmbientSH_B2`,({lighting:e})=>n(v,e.sh.b[5],e.sh.b[6],e.sh.b[7],e.sh.b[8]))),e.code.add(a`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
vec4 sh1 = vec4(
0.488603 * normal.x,
0.488603 * normal.z,
...
}`)}function E(e,t){let n=s(t.output)&&t.receiveShadows;n&&d(e,!0),e.vertex.code.add(a`
    void forwardLinearDepthToReadShadowMap() { ${i(n,`forwardLinearDepth(gl_Position.w);`)} }
  `)}var D=class extends o{constructor(e,t,n,r){super(e,`mat4`,2,(n,i,a,o)=>n.setUniformMatrices4fv(e,t(i,a,o),r),n)}},O=class extends o{constructor(e,t,n,r){super(e,`mat4`,1,(n,i,a)=>n.setUniformMatrices4fv(e,t(i,a),r),n)}};function k(e){e.fragment.uniforms.add(new O(`shadowMapMatrix`,(e,t)=>t.shadowMap.getShadowMapMatrices(e.origin),4)),j(e)}function A(e){e.fragment.uniforms.add(new D(`shadowMapMatrix`,(e,t)=>t.shadowMap.getShadowMapMatrices(e.origin),4)),j(e)}function j(e){let{fragment:t}=e;t.uniforms.add(new p(`cascadeDistances`,e=>e.shadowMap.cascadeDistances),new c(`numCascades`,e=>e.shadowMap.numCascades)),t.code.add(a`const vec3 invalidShadowmapUVZ = vec3(0.0, 0.0, -1.0);
...
}`)}export{b as a,m as c,y as d,T as i,w as l,F as n,g as o,P as r,h as s,C as t,x as u};