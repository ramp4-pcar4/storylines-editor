import{t as e}from"./glsl-EDZkDhgF-BmlD_e8i.js";import{t}from"./Float3PassUniform-BEhcqx4m-lPGwfhIL.js";import{t as n}from"./FloatPassUniform-gHcGW-mi-DcUQ2f5D.js";import{t as r}from"./Texture2DPassUniform-RVTT2Sjh-CghdmKcr.js";import{t as i}from"./Texture2DBindUniform-BjIiNL3v-DEktPz6m.js";import{t as a}from"./ReadDepth.glsl-DNR_DJR2-TOafqjrr.js";import{t as o}from"./CameraSpace.glsl-DhKWVhj4-D_yg_UDb.js";function s(e){e.code.add(`
  vec4 blendColorsPremultiplied(vec4 source, vec4 dest) {
    float oneMinusSourceAlpha = 1.0 - source.a;
    return source + dest * oneMinusSourceAlpha;
  }
  `)}function c(c,l){let u=c.fragment;u.include(a),c.include(o),u.include(s),u.uniforms.add(new n(`globalAlpha`,e=>e.globalAlpha),new t(`glowColor`,e=>e.glowColor),new n(`glowWidth`,(e,t)=>e.glowWidth*t.camera.pixelRatio),new n(`glowFalloff`,e=>e.glowFalloff),new t(`innerColor`,e=>e.innerColor),new n(`innerWidth`,(e,t)=>e.innerWidth*t.camera.pixelRatio),new i(`depthMap`,e=>e.depth?.attachment),new r(`normalMap`,e=>e.normals)),u.code.add(e`vec4 premultipliedColor(vec3 rgb, float alpha) {
