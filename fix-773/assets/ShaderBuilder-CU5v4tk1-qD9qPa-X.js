import{a3 as T,h as g}from"./main-D8UjLOIQ.js";import{n as c}from"./BindType-CKbZk6AG-Bqvzo9NX.js";const l=()=>T.getLogger("esri.views.3d.webgl-engine.core.shaderModules.shaderBuilder");class f{constructor(){this._includedModules=new Map}include(e,t){this._includedModules.has(e)?this._includedModules.get(e):(this._includedModules.set(e,t),e(this.builder,t))}}class D extends f{constructor(){super(...arguments),this.vertex=new p,this.fragment=new p,this.attributes=new I,this.varyings=new A,this.extensions=new m,this.outputs=new d}get fragmentUniforms(){return this.fragment.uniforms.entries}get builder(){return this}generate(e,t=!1){const r=this.extensions.generateSource(e),i=this.attributes.generateSource(e),a=this.varyings.generateSource(e),n=e==="vertex"?this.vertex:this.fragment,u=n.uniforms.generateSource(),h=n.code.generateSource(),b=n.main.generateSource(t),_=e==="vertex"?F:E,S=n.constants.generateSource(),$=this.outputs.generateSource(e);return`#version 300 es
${r.join(`
`)}
${_}
${S.join(`
