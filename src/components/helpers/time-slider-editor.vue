<template>
    <div class="px-5 pt-4">
        <div class="flex items-center">
            <label class="standard-label">{{ $t('editor.map.timeslider.range') }}</label>
            <input
        ...
        <br />
        <div class="flex items-center">
            <label class="standard-label">{{ $t('editor.map.timeslider.start') }}</label>
            <input
                class="standard-input ml-3"
                type="number"
        ...
        <div class="border-black border-2 p-3 w-2/3" v-if="error">
            <label class="standard-label w-full">{{ $t('editor.map.timeslider.warning') }}</label>
            <br />
        ...
        <br v-if="error" />
        <div>
            <label class="standard-label">{{ $t('editor.map.timeslider.attribute') }}</label>
            <input
                class="standard-input"
        ...
        <br />
        <div>
            <label class="standard-label">{{ $t('editor.map.timeslider.layers') }}</label>
            <br />
            <input
