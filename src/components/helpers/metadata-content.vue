<template>
    ...
    <section>
        ...
        <div class="metadata-item">
            ...
            <p v-if="!editing">{{ metadata.title || 'N/A' }}</p>
        </div>
        <!-- ToC orientation -->
        <div class="metadata-item">
            ...
            <p v-if="!editing">{{ metadata.tocOrientation || 'N/A' }}</p>
        </div>
        ...
        <div class="metadata-item">
            ...
            <p v-if="!editing">{{ metadata.tocOrientation ? 'Enabled' : 'Disabled' }}</p>
        </div>
    </section>
    <!-- Section: Introduction page details -->
    <section class="border rounded-md px-5 py-3">
        ...
        <section class="flex gap-2 flex-wrap">
            ...
            <div class="metadata-item w-full md:w-5/12 flex-1">
                ...
                <p v-if="!editing">{{ metadata.introTitle || 'N/A' }}</p>
            </div>
            <!-- Intro subtitle -->
            <div class="metadata-item w-full md:w-5/12 flex-1">
                ...
                <p v-if="!editing">{{ metadata.introSubtitle || 'N/A' }}</p>
            </div>
        </section>
        ...
        <section>
            <div class="metadata-item">
                ...
                <p class="break-all" v-if="!editing">{{ metadata.logoName || 'N/A' }}</p>
            </div>
            <!-- Logo Preview -->
            ...
            <div class="metadata-item">
                ...
                <p v-if="!editing">{{ metadata.logoAltText || 'N/A' }}</p>
            </div>
        </section>
    </section>
    <!-- Section: End of page information -->
    <section class="border mt-5 rounded-md px-5 py-3">
        ...
        <div class="metadata-item">
            ...
            <p class="break-all" v-if="!editing">{{ metadata.contextLink || 'N/A' }}</p>
        </div>
        <!-- Context label -->
        <div class="metadata-item">
            ...
            <p v-if="!editing">{{ metadata.contextLabel || 'N/A' }}</p>
        </div>
        <!-- Date modified -->
        <div class="metadata-item">
            ...
            <p v-if="!editing">{{ metadata.dateModified || 'N/A' }}</p>
        </div>
    </section>
</template>
