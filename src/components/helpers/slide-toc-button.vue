<template>
    ...
    >
        ...
        <div class="flex flex-col gap-0.5">
            ...
            <div class="flex gap-0.5" v-focus-list="'horizontal'">
                <div
...
export default class SlideTocV extends Vue {
    ...
    determinePanelImage(type: PanelType): string {
        ...
        switch (type) {
            case PanelType.Text:
                return this.textEditorIcon;
            case PanelType.Image:
                return this.imageEditorIcon;
            case PanelType.Map:
                return this.mapEditorIcon;
            case PanelType.Chart:
                return this.chartEditorIcon;
            case PanelType.Video:
                return this.videoEditorIcon;
            case PanelType.Audio:
                return this.audioEditorIcon;
            case PanelType.Slideshow:
                return this.slideshowEditorIcon;
            case PanelType.Dynamic:
                return this.dynamicEditorIcon;
            default:
                return '';
        }
    }
