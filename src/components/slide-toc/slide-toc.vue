 ...
 */
function selectSlide(index: number, lang: string, panelIndex?: number): void {
    emit('slide-change', index, lang, panelIndex);
}
...
function copyConfigFromOtherLang(index: number, currLang: keyof MultiLanguageSlide): void {
...
function copySlide(index: number): void {
    ...
    selectSlide(index, editorStore.selectedSlideLang);
