...
export default class StoryPreviewV extends Vue {
    ...
    created(): void {
        ...
        if (this.config) {
            this.config.slides = this.config.slides.filter((slide) => Object.keys(slide).length);
        }
        if (this.configs['en']) {
            this.configs['en'].slides = this.configs['en'].slides.filter((slide) => Object.keys(slide).length);
        }
        if (this.configs['fr']) {
            this.configs['fr'].slides = this.configs['fr'].slides.filter((slide) => Object.keys(slide).length);
        }
