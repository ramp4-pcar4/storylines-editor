...
export default class ImageEditorV extends Vue {
    ...
    async addUploadedFile(file: File): Promise<ImageFile> {
        ...
        // however, the promise inside is empty, then the shared asset folder contains an asset with the
        ...
        // does not exist in the opposite lang's asset folder anymore. If not, we move it there
        if (!inSharedAsset) {
