<template>
    <div class="flex flex-col mt-4">
        <label class="standard-label text-left" for="mapTitle">{{ $t('editor.map.title') }}</label>
        <input class="standard-input" type="text" id="mapTitle" v-model="panel.title" />
        ...
        <div>
            <div class="flex items-center gap-2 mt-2">
                ...
                />
                <label class="standard-label" for="timeSliderToggle">{{ $t('editor.map.timeslider.enable') }}</label>
                ...
                <button
                    ...
                    class="standard-button black-bg-button thin-button block md:inline-block ml-0 text-sm"
                >
            ...
            <div class="flex flex-col w-full text-left mt-5 mb-1">
                <label class="standard-label" for="rampMapCaption"> {{ $t('editor.image.label.caption') }}</label>
                <input
                    id="rampMapCaption"
                    class="standard-input w-full lg:w-2/5"
                    type="text"
        ...
        >
            ...
            <div class="w-full flex justify-end">
                <button
                    class="standard-button black-bg-button"
