<template>
    <div class="block">
        ...
        <div class="flex flex-col mt-4 align-center w-full text-left">
            <label class="standard-label text-label" for="videoTitle">{{ $t('editor.video.title') }}</label>
            <input
                id="videoTitle"
                class="standard-input w-full lg:w-3/5"
                type="text"
        ...
        >
            <label class="flex standard-label drag-label cursor-pointer">
        ...
        <div class="flex flex-col mt-4 w-full text-left">
            <div class="flex items-center gap-1.5">
                <label class="standard-label" for="videoURL">{{
            ...
            <div class="flex items-center gap-1.5 w-full">
                <input
                    ref="videoUrl"
                    id="videoURL"
                    class="standard-input flex-1"
                    type="search"
                    v-model="videoPreview.src"
                    v-if="videoPreview.videoType !== 'local'"
                />
                <input ref="videoUrl" id="videoURL" class="standard-input flex-1" type="search" v-else />
                <button
