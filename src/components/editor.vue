...
export default class EditorV extends Vue {
    ...
    updateSlides(slides: SlideForBothLanguages[]): void {
        ...
        this.configs.en!.slides = this.slides.filter((slides) => slides.en).map((slides) => slides.en!);
        this.configs.fr!.slides = this.slides.filter((slides) => slides.fr).map((slides) => slides.fr!);
    }
