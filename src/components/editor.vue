            ...
            >
                <div class="flex flex-row justify-between items-center px-3 py-1">
                    <div class="flex flex-row items-center gap-2">
                        ...
                        >
                            <button
                                class="standard-button transparent-button dynamic-header-button"
                                truncate-trigger
                                tabindex="0"
                            >
                                <svg
                        ...
                        <button
                            ...
                            class="standard-button gray-border-button dynamic-header-button md:hidden"
                            v-tippy="{
                                delay: '200',
                                placement: 'bottom',
                    ...
                    <div class="space-x-2 flex flex-row items-center">
                        ...
                        <button
                            ...
                            class="standard-button gray-border-button dynamic-header-button"
                            truncate-trigger
                        >
                            <svg
                        ...
                        <button
                            @click="saveChanges"
                            class="standard-button black-bg-button dynamic-header-button"
