        ...
        <div class="flex flex-col items-center">
            ...
            <div class="flex flex-wrap flex-col items-center gap-y-3 mt-12 mx-8 justify-center">
                ...
                <div>
                    ...
                    <!-- TODO: Change manually if this translation changes! -->
                    <!-- Editor (FR) title) -->
                    <h1 style="padding-top: 2px" class="text-2xl font-bold text-center text-gray-400">
                        Éditeur et outil de création de scénarios RAMP
                    </h1>
                </div>
            </div>

            <!-- Greeting with username -->
            <!-- TODO: Change manually if french translation changes! -->
            <p class="text-md font-semibold mt-2">
                {{ $t('editor.landing.greeting') }}, {{ userName }}! / Bonjour, {{ userName }}!
            </p>
