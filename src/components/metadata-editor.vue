                    ...
                    <section>
                        ...
                        <div class="pb-5 pt-1">
                            ...
                            <div v-if="renaming" class="flex flex-row items-center w-full md:w-3/4">
                                ...
                                <button
                                    @click="renameProduct"
                                    class="editor-button editor-forms-button bg-black text-white focus:bg-gray-600 hover:bg-gray-800 outline-white"
                            ...
                            <div v-else class="flex flex-row items-center">
                                <div class="flex flex-row items-center w-full">
                                    ...
                                    <button
                                        ...
                                        "
                                        class="editor-button editor-forms-button bg-black text-white focus:bg-gray-600 hover:bg-gray-800 mr-0"
                                        :class="{ 'input-error': error }"
                                        :disabled="loadStatus === 'loading'"
                                        v-if="editExisting"
                                    >
