        ...
        <template v-if="!loadEditor">
                    ...
                    <section>
                        ...
                        <div class="pb-5 pt-1">
                            ...
                            <div v-if="renameMode" class="flex flex-row items-center w-full md:w-3/4">
                                ...
                                <input
                                    id="rename-input"
                                    class="standard-input mt-0 flex-2"
                                    type="search"
                                    @input="
                                        error = false;
                                        checkUuid(true);
                    ...
                    <section v-if="!editExisting || loadStatus === 'loaded'">
                        ...
                        <section v-if="editExisting" class="pb-10">
                            ...
                            <div class="flex flex-col gap-5 pt-5" v-if="storylineHistory.length !== 0">
                                <div class="flex">
                                    <button
                                        class="standard-button gray-border-button mainline-button"
                        ...
                        <section>
                            ...
                            <section class="mb-4 flex gap-2 items-start md:items-center flex-col md:flex-row">
                                ...
                                <button v-if="editExisting" @click="preview" class="standard-button gray-border-button">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="px-4 md:px-8 py-5 border rounded-md">
                                ...
                                <button
                                    ...
                                    class="standard-button gray-border-button md:float-right mb-3"
                                >
                                    <svg
                                        clip-rule="evenodd"
                                        fill-rule="evenodd"
                                ...
                                <div class="overflow-visible">
                                    ...
                                    <div v-if="editingMetadata && editExisting" class="flex gap-3 mt-2">
                                        ...
                                        <button @click="saveMetadata(true)" class="standard-button black-bg-button">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink"
                                                x="0px"
            ...
            <div class="flex px-7 md:px-20 py-5 mt-8" :disabled="loadStatus === 'loading'">
                ...
                <router-link :to="{ name: 'home' }" target tabindex="-1">
                    <button class="standard-button gray-border-button gap-1" tabindex="0">
                        <svg
                ...
                <div class="ml-auto">
                    ...
                    >
                        ...
                        <button
                            ...
                            class="standard-button black-bg-button gap-1"
                        >
                ...
                <template v-slot:metadataModal>
                    ...
                    >
                        <div @click.stop class="flex flex-col space-y-2">
                            <div class="sticky top-0 bg-white pt-3 mb-2 border-b border-gray-300">
