...
export default class MetadataEditorV extends Vue {
     ...
     * @param config The config within which the logo was uploaded
     */
    async uploadLogo(logo: File, config: StoryRampConfig): Promise<void> {
        console.log(' ');
    ...
    configFileStructureHelper(configZip: typeof JSZip, uploadLogo?: File | undefined): Promise<void> {
        ...
        // Upload the logo to the shared asset folder (due to cloning of configs in generateNewConfig)
