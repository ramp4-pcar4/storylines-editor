    ...
    <div class="editor-container">
                            ...
                            <div v-else class="flex flex-row items-center">
                                <div class="flex flex-row items-center w-full">
                                    ...
                                    <button
                                        ...
                                        "
                                        class="editor-button editor-forms-button bg-black text-white hover:bg-gray-800 mr-0"
                                        :class="{ 'input-error': error }"
                                        :disabled="loadStatus === 'loading'"
                                        v-if="editExisting"
                                    >
        ...
        <template v-if="loadEditor && loadStatus === 'loaded'">
            ...
            >
                ...
                <!-- Click outside the modal to discard changes. Click Done to save changes LOCALLY. -->
