    ...
    <div class="block mt-6">
        ...
        <div class="flex gap-2 border-b pb-1 px-1.5" style="border-color: rgba(209, 213, 219, 1)">
            <button
                ...
                class="standard-button transparent-button thin-button"
        ...
        <div v-if="editingStatus === 'panels'">
            <table class="w-2/3 mt-5">
                ...
                <tr class="table-add-row">
                    ...
                    <td>
                        <select v-model="newSlideType" class="standard-select justify-self-center">
                    ...
                    <td>
                        <button class="standard-button gray-border-button thin-button justify-self-center" @click="createNewSlide" :disabled="idUsed || !newSlideName">
                            {{ $t('dynamic.panel.add') }}
                        </button>
                    </td>
                </tr>
