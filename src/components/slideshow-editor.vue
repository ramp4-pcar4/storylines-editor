<template>
    <div class="block my-3">
        ...
        <!-- Slideshow caption -->
        <div class="mt-5 mb-8">
            <label class="standard-label" for="slideshowCaption">{{ $t('editor.image.slideshowCaption') }}</label>
            <input
                id="slideshowCaption"
                class="standard-input block w-full lg:w-1/2"
                type="text"
                    ...
                    >
                        ...
                        >
                            <button
                                ...
                                class="standard-button transparent-button"
                                v-tippy="{
                                    delay: '200',
                                    placement: 'top',
                            ...
                            <button
                                ...
                                style="border: none !important; padding-left: 0.375rem; padding-right: 0.375rem"
                                class="standard-button transparent-button rotate-180 transform"
                                v-tippy="{
                                    delay: '200',
                                    placement: 'top',
        ...
        <!-- add item button -->
        <button
            class="standard-button w-full lg:w-4/5 max-h-96 bg-gray-100 border border-gray-400 hover:bg-gray-200"
        ...
        >
            ...
            <div>
                <div class="mt-3" v-if="editingStatus === 'create'">
                    <!-- Creating new slide -->
                    <label class="standard-label mb-5 text-left">{{ $t('editor.slideshow.label.type') }}</label>
                    <br />
