<template>
    <div class="block my-3">
        ...
        <table class="w-full lg:w-4/5 mt-5 border border-gray-400 rounded-md border-separate">
            <thead>
            ...
            <tbody>
                ...
                <tr v-else>
                    <td class="self-center text-center italic" colspan="4">{{ $t('editor.slideshow.noSlides') }}</td>
                </tr>
            </tbody>
        </table>
        <br /><br />
