...
export const useProductStore = defineStore('product', {
    ...
    actions: {
        ...
        loadSlides(configs: { [p: string]: StoryRampConfig | undefined }): void {
            ...
            this.slidesWorkingCopy = Array.from({ length: maxLength }, (_, index) =>
...
.centerSlideRight {\n\ttext-align: right;\n}\n\n.centerSlideFull {\n\ttext-align: center;\n}\n\n`;
         ...
         */
        generateConfig(publish = true): Promise<ConfigFileStructure> {
            const editorStore = useEditorStore();
            const lockStore = useLockStore();
            const stateStore = useStateStore();
        ...
        /**
         * Helper for generateConfig(). Calls the /upload endpoint to upload the product to the server
         */
